...
public class Game extends JFrame implements ActionListener
{
   ...
   /**
     * Constructs a new Game object from the indicated dimensions and menu.
     *
     * @param rows The number of rows.
     * @param cols The number of cols.
     * @param menu The main menu from which the game is launched.
     */
   public Game(int rows, int cols, MainMenu menu)
   {
	...
	/**
     * Constructs a new Game object from the indicated slot and menu.
     *
     * @param slot The slot from which to load the game.
     * @param menu The main menu from which the game is launched.
     */
